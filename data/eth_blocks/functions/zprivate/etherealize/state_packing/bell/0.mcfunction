...
execute if block ~ ~ ~ minecraft:bell[attachment=ceiling] run data modify storage eth_block:data BlockStates.attachment set value "ceiling"
execute if block ~ ~ ~ minecraft:bell[attachment=single_wall] run data modify storage eth_block:data BlockStates.attachment set value "single_wall"
execute if block ~ ~ ~ minecraft:bell[attachment=double_wall] run data modify storage eth_block:data BlockStates.attachment set value "double_wall"
